...
<spring:url value="/resources/css/teamCreateStyle.css"
	var="teamCreateStyle" />
...
<body>
	...
	<br />
	<br />
	<h3><%=session.getAttribute("teamName")%><br />
	</h3>
	...
	<div class="dropdown">
		...
		<div id="myDropdown" class="dropdown-content">
			...
			<c:forEach var="user" items="${userList}">
				<a href="savemember/${user.userId}">${user.userName}</a>
	...
	<br /> ${teamCreatorName}(Team Creator)
	<br />
